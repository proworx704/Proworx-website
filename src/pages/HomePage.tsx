...
const FAQ_ITEMS: { question: string; answer: string }[] = [
  ...
  },
  {
    ...
    answer: "We recommend a maintenance wash every 2–4 weeks, a full detail every 6 months, and annual paint correction or ceramic coating inspection. Our <a href=\"/maintenance\" class=\"text-gold hover:underline\">monthly maintenance plans</a> starting at $134.19/visit handle the regular care automatically.",
  },
  {
        ...
        <div className="container py-20 md:py-28">
          <div className="max-w-4xl">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-gold/30 bg-gold/10 text-gold text-sm font-medium mb-6 backdrop-blur-sm">
              ...
              GYEON & IGL Certified — 5.0 Stars (63+ Reviews)
            </div>
        ...
        <div className="container">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-5xl mx-auto text-center">
            {[
              ...
              { icon: <Star className="size-8" />, label: "5.0 Stars", sub: "63+ Google Reviews" },
            ].map((item) => (
      ...
      <section className="py-20 md:py-28 bg-card/50">
        <div className="container">
          <div className="text-center mb-14">
            ...
            <p className="text-muted-foreground text-lg">5.0 Stars — 63+ Reviews on Google</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5 max-w-6xl mx-auto">
