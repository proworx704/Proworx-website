  ...
  return (
    <div className="flex-1 flex flex-col">
      <PageSEO
        ...
        description="Charlotte's top-rated auto detailing and ceramic coating service. GYEON & IGL certified. Interior & exterior detail, paint correction, ceramic coating from $499. 5.0★ with 61+ reviews. Mobile or drop-off."
        ...
        <div className="container py-20 md:py-28">
          <div className="max-w-4xl">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl leading-relaxed mb-8">
              ...
              and premium detailing — mobile or drop-off. 61+ five-star reviews.
            </p>
