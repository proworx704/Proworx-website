  ...
  const insideOutTiers = [
    {
      ...
      priceTiers: [
        { label: "Sedan / Coupe", duration: "2 hrs", price: "$206.28" },
        { label: "Small SUV / Truck", duration: "2 hr 30 min", price: "$257.78" },
        { label: "Large SUV / Off-Road Truck", duration: "3 hrs", price: "$309.27" },
        { label: "Van", duration: "3 hr 30 min", price: "$360.76" },
      ],
      notes: [],
    },
    {
