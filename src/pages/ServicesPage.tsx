  ...
  const insideOutTiers = [
    {
      ...
      priceTiers: [
        { label: "Sedan", duration: "2 hr 30 min", price: "$180" },
        { label: "Small SUV / Small Truck", duration: "3 hrs", price: "$216" },
        { label: "Large SUV / Off-Road Truck", duration: "3 hr 30 min", price: "$252" },
    ...
    },
    {
      ...
      priceTiers: [
        { label: "Sedan", duration: "5 hr 30 min", price: "$673" },
        { label: "Small SUV / Small Truck", duration: "6 hrs", price: "$709" },
  ...
  const interiorTiers = [
    {
      ...
      priceTiers: [
        { label: "Sedan", duration: "1 hr 45 min", price: "$127" },
        { label: "Small SUV / Small Truck", duration: "2 hrs", price: "$144" },
        { label: "Large SUV / Off-Road Truck", duration: "2 hr 30 min", price: "$180" },
