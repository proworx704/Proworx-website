  ...
  const insideOutTiers = [
    {
      ...
      priceTiers: [
        { label: "Sedan", duration: "2 hr 30 min", price: "$165" },
        { label: "Small SUV / Small Truck", duration: "3 hrs", price: "$206" },
        { label: "Large SUV / Off-Road Truck", duration: "3 hr 30 min", price: "$247" },
        { label: "Van", duration: "4 hrs", price: "$288" },
      ],
    ...
    },
    {
      ...
      priceTiers: [
        { label: "Sedan", duration: "3 hr 30 min", price: "$296" },
        { label: "Small SUV / Small Truck", duration: "4 hrs", price: "$337" },
        { label: "Large SUV / Off-Road Truck", duration: "4 hr 30 min", price: "$378" },
    ...
    },
    {
      ...
      priceTiers: [
        { label: "Sedan", duration: "3 hr 30 min", price: "$435" },
        { label: "Small SUV / Small Truck", duration: "4 hrs", price: "$476" },
        { label: "Large SUV / Off-Road Truck", duration: "4 hr 30 min", price: "$517" },
    ...
    },
    {
      ...
      priceTiers: [
        { label: "Sedan", duration: "5 hr 30 min", price: "$658" },
        { label: "Small SUV / Small Truck", duration: "6 hrs", price: "$699" },
        { label: "Large SUV / Off-Road Truck", duration: "6 hr 30 min", price: "$740" },
  ...
  const interiorTiers = [
    {
      ...
      priceTiers: [
        { label: "Sedan", duration: "1 hr 45 min", price: "$124" },
        { label: "Small SUV / Small Truck", duration: "2 hrs", price: "$144" },
        { label: "Large SUV / Off-Road Truck", duration: "2 hr 30 min", price: "$165" },
        { label: "Van", duration: "3 hrs", price: "$206" },
      ],
      notes: ["Pet Hair Fee: Additional time charged at base rate.", "Condition: Extra time/cost may apply for neglected vehicles."],
    },
    {
      ...
      priceTiers: [
        { label: "Sedan", duration: "2 hr 55 min", price: "$255" },
        { label: "Small SUV / Small Truck", duration: "3 hr 15 min", price: "$275" },
        { label: "Large SUV / Off-Road Truck", duration: "3 hr 45 min", price: "$296" },
        { label: "Van", duration: "4 hr 15 min", price: "$337" },
      ],
    ...
    },
    {
      ...
      priceTiers: [
        ...
        { label: "Large SUV / Off-Road Truck", duration: "4 hr 15 min", price: "$352" },
        { label: "Van", duration: "4 hr 45 min", price: "$393" },
      ],
  ...
  const exteriorTiers = [
    {
      ...
      priceTiers: [
        { label: "Sedan", duration: "1 hr 15 min", price: "$103" },
        { label: "Small SUV / Small Truck", duration: "1 hr 30 min", price: "$124" },
    ...
    },
    {
      ...
      priceTiers: [
        { label: "Sedan", duration: "2 hr 25 min", price: "$373" },
        { label: "Small SUV / Small Truck", duration: "2 hr 40 min", price: "$394" },
        { label: "Large SUV / Off-Road Truck", duration: "3 hrs", price: "$414" },
        { label: "Van", duration: "3 hr 15 min", price: "$435" },
      ],
    ...
    },
    {
      ...
      priceTiers: [
        { label: "Sedan", duration: "2 hr 45 min", price: "$409" },
        { label: "Small SUV / Small Truck", duration: "3 hrs", price: "$430" },
        { label: "Large SUV / Off-Road Truck", duration: "3 hr 20 min", price: "$450" },
        { label: "Van", duration: "3 hr 35 min", price: "$471" },
      ],
      notes: ["Bundled add-ons at 15% off with ceramic upgrades.", "Condition: Extra time/cost may apply for neglected vehicles."],
    },
  ];
          ...
          "@graph": [
            ...
            },
            {
              ...
              "mainEntity": [
                ...
                { "@type": "Question", "name": "How much does a full detail cost in Charlotte NC?", "acceptedAnswer": { "@type": "Answer", "text": "Standard Inside & Out starts at $165 (Sedan) and includes full interior vacuum, surface wipe-down, hand wash, wheels & tires, and spray wax. Choose Premium Interior Focus (from $296) for leather care, steam cleaning, and UV protection, or Premium Exterior Focus (from $435) for clay bar, paint sealant, and trim restoration — both at 10% off bundled add-ons. Our Elite Ceramic package starts at $658 with full ceramic upgrades including GYEON Leather Shield, ceramic tire/trim, and 12-month ceramic wax at 15% off. SUV and Van pricing available on our services page." }},
