  ...
  const insideOutTiers = [
    {
      ...
      priceTiers: [
        { label: "Sedan", duration: "2 hr 30 min", price: "$225" },
        { label: "Small SUV / Small Truck", duration: "3 hrs", price: "$270" },
        { label: "Large SUV / Off-Road Truck", duration: "3 hr 30 min", price: "$315" },
        { label: "Van", duration: "4 hrs", price: "$360" },
      ],
    ...
    },
    {
      ...
      priceTiers: [
        { label: "Sedan", duration: "3 hr 30 min", price: "$360" },
        { label: "Small SUV / Small Truck", duration: "4 hrs", price: "$405" },
        { label: "Large SUV / Off-Road Truck", duration: "4 hr 30 min", price: "$450" },
        { label: "Van", duration: "5 hrs", price: "$495" },
      ],
      notes: ["Pet Hair Fee: Additional time charged at base rate.", "Condition: Extra time/cost may apply for neglected vehicles."],
    },
    {
      ...
      priceTiers: [
        { label: "Sedan", duration: "4 hr 30 min", price: "$450" },
        { label: "Small SUV / Small Truck", duration: "5 hrs", price: "$495" },
        { label: "Large SUV / Off-Road Truck", duration: "5 hr 30 min", price: "$540" },
        { label: "Van", duration: "6 hrs", price: "$585" },
      ],
      notes: ["Pet Hair Fee: Additional time charged at base rate.", "Condition: Extra time/cost may apply for neglected vehicles."],
    },
  ];
  ...
  const interiorTiers = [
    {
      ...
      priceTiers: [
        { label: "Sedan", duration: "1 hr 45 min", price: "$158" },
        { label: "Small SUV / Small Truck", duration: "2 hrs", price: "$180" },
        { label: "Large SUV / Off-Road Truck", duration: "2 hr 30 min", price: "$225" },
        { label: "Van", duration: "3 hrs", price: "$270" },
      ],
      notes: ["Pet Hair Fee: Additional time charged at base rate.", "Condition: Extra time/cost may apply for neglected vehicles."],
    },
    {
      ...
      priceTiers: [
        { label: "Sedan", duration: "2 hr 55 min", price: "$262" },
        { label: "Small SUV / Small Truck", duration: "3 hr 15 min", price: "$292" },
        { label: "Large SUV / Off-Road Truck", duration: "3 hr 45 min", price: "$338" },
        { label: "Van", duration: "4 hr 15 min", price: "$382" },
      ],
      notes: ["Pet Hair Fee: Additional time charged at base rate.", "Condition: Extra time/cost may apply for neglected vehicles."],
    },
  ];
  ...
  const exteriorTiers = [
    {
      ...
      priceTiers: [
        { label: "Sedan", duration: "1 hr 15 min", price: "$112" },
        { label: "Small SUV / Small Truck", duration: "1 hr 30 min", price: "$135" },
        { label: "Large SUV / Off-Road Truck", duration: "1 hr 45 min", price: "$158" },
        { label: "Van", duration: "2 hrs", price: "$180" },
      ],
    ...
    },
    {
      ...
      priceTiers: [
        { label: "Sedan", duration: "2 hr 25 min", price: "$218" },
        { label: "Small SUV / Small Truck", duration: "2 hr 40 min", price: "$240" },
        { label: "Large SUV / Off-Road Truck", duration: "3 hrs", price: "$270" },
        { label: "Van", duration: "3 hr 15 min", price: "$292" },
      ],
      notes: ["Condition: Extra time/cost may apply for neglected vehicles."],
    },
    {
      ...
      priceTiers: [
        { label: "Sedan", duration: "2 hr 45 min", price: "$248" },
        { label: "Small SUV / Small Truck", duration: "3 hrs", price: "$270" },
        { label: "Large SUV / Off-Road Truck", duration: "3 hr 20 min", price: "$300" },
        { label: "Van", duration: "3 hr 35 min", price: "$322" },
      ],
      notes: ["Condition: Extra time/cost may apply for neglected vehicles."],
    },
  ];
  ...
  return (
    <div className="flex-1 flex flex-col">
      <PageSEO
        ...
        description="Mobile auto detailing in Charlotte, NC — Standard, Premium & Elite packages for interior, exterior & full details. Starting at $112. Ceramic coating, paint correction & monthly plans. We come to you!"
      ...
      <section className="relative py-20 md:py-28 overflow-hidden">
        <div className="absolute inset-0 -z-10">
          <CmsImg slot="services-hero" fallback="/images/corvette-front.jpg" alt="Black Corvette ZR1 detailed by ProWorx" className="w-full h-full object-cover" loading="eager" focalY={25} />
