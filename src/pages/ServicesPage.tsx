  ...
  const insideOutTiers = [
    {
      ...
      priceTiers: [
        { label: "Sedan / Coupe", duration: "1 hr 45 min", price: "$180.54" },
        { label: "Small SUV / Truck", duration: "2 hr 15 min", price: "$232.03" },
        { label: "Large SUV / Off-Road Truck", duration: "2 hr 45 min", price: "$283.52" },
        { label: "Van", duration: "3 hr 15 min", price: "$335.02" },
      ],
      notes: [],
    },
    {
      ...
      priceTiers: [
        { label: "Sedan", duration: "2 hr 30 min", price: "$257.78" },
        { label: "Small SUV / Small Truck", duration: "3 hrs", price: "$309.27" },
        { label: "Large SUV / Off-Road Truck", duration: "3 hr 30 min", price: "$360.76" },
        { label: "Van", duration: "4 hrs", price: "$412.26" },
      ],
    ...
    },
    {
      ...
      priceTiers: [
        { label: "Sedan", duration: "5 hr 15 min", price: "$598.66" },
        { label: "Small SUV / Small Truck", duration: "5 hr 45 min", price: "$651.18" },
        { label: "Large SUV / Off-Road Truck", duration: "6 hr 15 min", price: "$704.74" },
        { label: "Van", duration: "6 hr 45 min", price: "$757.26" },
      ],
          ...
          "@graph": [
            ...
            },
            {
              ...
              "mainEntity": [
                ...
                { "@type": "Question", "name": "Do you offer monthly detailing plans?", "acceptedAnswer": { "@type": "Answer", "text": "Yes! We offer five monthly maintenance plans: Exterior Only ($59/mo), Interior Only ($99/mo), Full Inside & Out ($159/mo with ceramic protection), Ceramic Exterior ($109/mo), and Ceramic Inside & Out ($184.76/mo). All plans include scheduled service and can be canceled anytime." }},
