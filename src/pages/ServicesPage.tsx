...
export function ServicesPage() {
  ...
  const insideOutTiers = [
    {
      ...
      priceTiers: [
        { label: "Sedan", duration: "2 hrs", price: "$165" },
        { label: "Small SUV / Small Truck", duration: "2 hr 30 min", price: "$206" },
        { label: "Large SUV / Off-Road Truck", duration: "3 hrs", price: "$247" },
        { label: "Van", duration: "3 hr 30 min", price: "$288" },
      ],
  ...
  const interiorTiers = [
    {
      ...
      priceTiers: [
        { label: "Sedan", duration: "1 hr 30 min", price: "$124" },
        { label: "Small SUV / Small Truck", duration: "1 hr 45 min", price: "$144" },
        { label: "Large SUV / Off-Road Truck", duration: "2 hrs", price: "$165" },
        { label: "Van", duration: "2 hr 30 min", price: "$206" },
      ],
      notes: ["Pet Hair Fee: Additional time charged at base rate.", "Condition: Extra time/cost may apply for neglected vehicles."],
    },
    {
      ...
      priceTiers: [
        { label: "Sedan", duration: "2 hr 45 min", price: "$255" },
        { label: "Small SUV / Small Truck", duration: "3 hrs", price: "$275" },
        { label: "Large SUV / Off-Road Truck", duration: "3 hr 30 min", price: "$296" },
        { label: "Van", duration: "4 hrs", price: "$337" },
      ],
  ...
  const exteriorTiers = [
    ...
    },
    {
      ...
      priceTiers: [
        { label: "Sedan", duration: "2 hr 30 min", price: "$373" },
        { label: "Small SUV / Small Truck", duration: "2 hr 45 min", price: "$394" },
    ...
    },
    {
      ...
      priceTiers: [
        { label: "Sedan", duration: "3 hr 15 min", price: "$409" },
        { label: "Small SUV / Small Truck", duration: "3 hr 30 min", price: "$430" },
        { label: "Large SUV / Off-Road Truck", duration: "3 hr 45 min", price: "$450" },
        { label: "Van", duration: "4 hrs", price: "$471" },
      ],
