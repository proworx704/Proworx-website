...
export function ServicesPage() {
  ...
  const insideOutTiers = [
    ...
    },
    {
      ...
      priceTiers: [
        { label: "Sedan", duration: "3 hr 30 min", price: "$364" },
        { label: "Small SUV / Small Truck", duration: "4 hrs", price: "$410" },
        { label: "Large SUV / Off-Road Truck", duration: "4 hr 30 min", price: "$456" },
        { label: "Van", duration: "5 hrs", price: "$503" },
      ],
    ...
    },
    {
      ...
      priceTiers: [
        { label: "Sedan", duration: "3 hr 30 min", price: "$503" },
        { label: "Small SUV / Small Truck", duration: "4 hrs", price: "$549" },
        { label: "Large SUV / Off-Road Truck", duration: "4 hr 30 min", price: "$595" },
        { label: "Van", duration: "5 hrs", price: "$642" },
      ],
    ...
    },
    {
      ...
      priceTiers: [
        { label: "Sedan", duration: "5 hr 30 min", price: "$726" },
        { label: "Small SUV / Small Truck", duration: "6 hrs", price: "$772" },
        { label: "Large SUV / Off-Road Truck", duration: "6 hr 30 min", price: "$818" },
        { label: "Van", duration: "7 hrs", price: "$865" },
      ],
  ...
  const interiorTiers = [
    ...
    },
    {
      ...
      priceTiers: [
        { label: "Sedan", duration: "2 hr 45 min", price: "$294" },
        { label: "Small SUV / Small Truck", duration: "3 hrs", price: "$317" },
        { label: "Large SUV / Off-Road Truck", duration: "3 hr 30 min", price: "$364" },
        { label: "Van", duration: "4 hrs", price: "$410" },
      ],
    ...
    },
    {
      ...
      priceTiers: [
        { label: "Sedan", duration: "3 hr 30 min", price: "$350" },
        { label: "Small SUV / Small Truck", duration: "3 hr 45 min", price: "$373" },
        { label: "Large SUV / Off-Road Truck", duration: "4 hr 15 min", price: "$420" },
        { label: "Van", duration: "4 hr 45 min", price: "$466" },
      ],
  ...
  const exteriorTiers = [
    ...
    },
    {
      ...
      priceTiers: [
        { label: "Sedan", duration: "2 hr 30 min", price: "$387" },
        { label: "Small SUV / Small Truck", duration: "2 hr 45 min", price: "$410" },
        { label: "Large SUV / Off-Road Truck", duration: "3 hrs", price: "$433" },
        { label: "Van", duration: "3 hr 15 min", price: "$456" },
      ],
    ...
    },
    {
      ...
      priceTiers: [
        { label: "Sedan", duration: "3 hr 15 min", price: "$423" },
        { label: "Small SUV / Small Truck", duration: "3 hr 30 min", price: "$446" },
        { label: "Large SUV / Off-Road Truck", duration: "3 hr 45 min", price: "$469" },
        { label: "Van", duration: "4 hrs", price: "$492" },
      ],
