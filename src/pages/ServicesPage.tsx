...
export function ServicesPage() {
  ...
  const insideOutTiers = [
    {
      ...
      priceTiers: [
        { label: "Sedan", duration: "2 hr 30 min", price: "$206" },
        { label: "Small SUV / Small Truck", duration: "3 hrs", price: "$247" },
        { label: "Large SUV / Off-Road Truck", duration: "3 hr 30 min", price: "$288" },
    ...
    },
    {
      ...
      priceTiers: [
        { label: "Sedan", duration: "3 hr 30 min", price: "$288" },
        { label: "Small SUV / Small Truck", duration: "4 hrs", price: "$330" },
        { label: "Large SUV / Off-Road Truck", duration: "4 hr 30 min", price: "$371" },
        { label: "Van", duration: "5 hrs", price: "$412" },
      ],
    ...
    },
    {
      ...
      priceTiers: [
        { label: "Sedan", duration: "5 hr 30 min", price: "$453" },
        { label: "Small SUV / Small Truck", duration: "6 hrs", price: "$494" },
        { label: "Large SUV / Off-Road Truck", duration: "6 hr 30 min", price: "$535" },
        { label: "Van", duration: "7 hrs", price: "$577" },
      ],
  ...
  const interiorTiers = [
    {
      ...
      priceTiers: [
        { label: "Sedan", duration: "1 hr 45 min", price: "$144" },
        { label: "Small SUV / Small Truck", duration: "2 hrs", price: "$165" },
    ...
    },
    {
      ...
      priceTiers: [
        { label: "Sedan", duration: "2 hr 45 min", price: "$227" },
        { label: "Small SUV / Small Truck", duration: "3 hrs", price: "$247" },
        { label: "Large SUV / Off-Road Truck", duration: "3 hr 30 min", price: "$288" },
        { label: "Van", duration: "4 hrs", price: "$330" },
      ],
    ...
    },
    {
      ...
      priceTiers: [
        { label: "Sedan", duration: "3 hr 30 min", price: "$288" },
        { label: "Small SUV / Small Truck", duration: "3 hr 45 min", price: "$309" },
        { label: "Large SUV / Off-Road Truck", duration: "4 hr 15 min", price: "$350" },
        { label: "Van", duration: "4 hr 45 min", price: "$391" },
      ],
  ...
  const exteriorTiers = [
    ...
    },
    {
      ...
      priceTiers: [
        { label: "Sedan", duration: "2 hr 30 min", price: "$206" },
        { label: "Small SUV / Small Truck", duration: "2 hr 45 min", price: "$227" },
        { label: "Large SUV / Off-Road Truck", duration: "3 hrs", price: "$247" },
        { label: "Van", duration: "3 hr 15 min", price: "$268" },
      ],
    ...
    },
    {
      ...
      priceTiers: [
        { label: "Sedan", duration: "3 hr 15 min", price: "$268" },
        { label: "Small SUV / Small Truck", duration: "3 hr 30 min", price: "$288" },
        { label: "Large SUV / Off-Road Truck", duration: "3 hr 45 min", price: "$309" },
        { label: "Van", duration: "4 hrs", price: "$330" },
      ],
