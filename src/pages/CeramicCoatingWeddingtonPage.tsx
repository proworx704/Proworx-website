...
const NEARBY = [
  ...
  { name: "Wesley Chapel", distance: "~12 min" },
];

export function CeramicCoatingWeddingtonPage() {
    ...
    <div className="flex-1 flex flex-col">
          ...
          "@graph": [
            {
              ...
              "itemListElement": [
                ...
                { "@type": "ListItem", "position": 3, "name": "Weddington NC", "item": "https://www.proworxdetailing.com/ceramic-coating-weddington-nc" }
              ]
            },
            {
              "@type": "LocalBusiness",
              "name": "ProWorx Detailing",
              "description": "GYEON & IGL certified ceramic coating and auto detailing serving Weddington, NC. Mobile service and drop-off available.",
              "url": "https://www.proworxdetailing.com/ceramic-coating-weddington-nc",
              ...
              "areaServed": { "@type": "City", "name": "Weddington", "containedInPlace": { "@type": "State", "name": "North Carolina" } },
            ...
            },
            {
              "@type": "FAQPage",
              "mainEntity": [
                { "@type": "Question", "name": "Is there a ceramic coating installer near Weddington NC?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. ProWorx Detailing is located in Waxhaw, ~10 min from our Waxhaw location. We offer mobile service (we come to your Weddington home) and drop-off at our Waxhaw location. GYEON & IGL certified with 56 five-star Google reviews." } },
                { "@type": "Question", "name": "How much does ceramic coating cost in Weddington?", "acceptedAnswer": { "@type": "Answer", "text": "Professional ceramic coating in Weddington starts at $499 for 1-year protection (GYEON Q² One EVO), $899 for 3-year (Q² Pure EVO), and $1,599 for 10-year (Q² Flash EVO). Price varies by vehicle size. All packages include prep wash, decontamination, and prep polish." } },
                { "@type": "Question", "name": "Does ProWorx offer mobile ceramic coating in Weddington?", "acceptedAnswer": { "@type": "Answer", "text": "Yes! We offer both mobile service and drop-off. For ceramic coating, drop-off is recommended for best results, but we accommodate mobile installations. Call (980) 272-1903 to discuss options." } }
              ]
            }
          ]
        }}
      ...
      <section className="relative py-20 md:py-28 overflow-hidden">
        <div className="absolute inset-0 -z-10">
          <CmsImg slot="weddington-hero" fallback="/images/tesla-bay.jpg" alt="Professional ceramic coating near Weddington NC" className="w-full h-full object-cover" />
        ...
        <div className="container">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-gold/30 bg-gold/10 text-gold text-sm font-medium mb-6">
              ...
              Serving Weddington, NC & Surrounding Areas
            </div>
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-black tracking-tight leading-[1.05] mb-6">
              Ceramic Coating{" "}
              <span className="text-gradient-gold">Weddington, NC</span>
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl leading-relaxed mb-8">
              Professional ceramic coating for Weddington residents. GYEON &amp; IGL certified installers with 12+ years experience and 56 five-star reviews. Mobile service or convenient drop-off — ~10 min from our Waxhaw location.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-x-6 gap-y-3 text-sm text-muted-foreground">
              {["GYEON & IGL Certified", "Mobile & Drop-Off", "5.0 Stars (56 Reviews)", "~10 min from Weddington"].map((item) => (
      ...
      <section className="py-16 md:py-20">
        <div className="container">
          <div className="max-w-5xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-sm font-semibold text-gold uppercase tracking-widest mb-3">Weddington, NC</p>
              <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-6">
                Why Weddington Residents Choose ProWorx
              </h2>
              <p className="text-muted-foreground leading-relaxed mb-4">
                Weddington is one of the wealthiest communities in the Charlotte metro — known for sprawling estates, equestrian properties, and residents who take pride in every detail. The driveways here hold everything from Range Rovers and Mercedes G-Wagons to weekend Corvettes and classic muscle cars.
              </p>
              <p className="text-muted-foreground leading-relaxed mb-6">
                Weddington homeowners protect their property values and their vehicles. With estate-size driveways and multi-car garages, our mobile ceramic coating service is the perfect fit — professional installation at your home without the hassle of drop-off.
              </p>
              <div className="grid grid-cols-2 gap-4">
                {[
                  { icon: <Shield className="size-5" />, label: "Certified Installers", sub: "GYEON & IGL" },
                  { icon: <Truck className="size-5" />, label: "Mobile Service", sub: "We come to Weddington" },
            ...
            <CmsImg slot="weddington-about" fallback="/images/porsche-van.jpg" alt="ProWorx mobile detailing serving Weddington NC" className="rounded-2xl w-full aspect-[4/3] object-cover shadow-2xl" />
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-20 bg-card/50">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-4">Ceramic Coating Packages for Weddington</h2>
      ...
      <section className="py-16 md:py-20">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-4">All Services Available in Weddington</h2>
          </div>
      ...
      <section className="py-16 md:py-20 bg-card/50">
        <div className="container">
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-4">Service Areas Near Weddington</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
              We serve Weddington and the entire South Charlotte metro area.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20">
        <div className="container">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-10 text-center">Common Questions — Weddington</h2>
            <div className="space-y-6">
              {[
                { q: "Do you offer ceramic coating in Weddington?", a: "Yes! ProWorx Detailing serves Weddington with both mobile service (we come to your home or office) and drop-off at our Waxhaw location, ~10 min from our Waxhaw location. We're GYEON & IGL certified with 56 five-star Google reviews." },
                { q: "How much does ceramic coating cost in Weddington?", a: "Professional ceramic coating in Weddington starts at $499 for 1-year protection (GYEON Q² One EVO), $899 for 3-year protection (Q² Pure EVO), and $1,599 for 10-year protection (Q² Flash EVO). Pricing varies by vehicle size. We require a 30% deposit to book." },
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-muted-foreground text-lg mb-8 max-w-xl mx-auto">
              Book a ceramic coating consultation with Charlotte's certified specialists. Mobile service to your Weddington home or drop-off at our Waxhaw facility.
            </p>
