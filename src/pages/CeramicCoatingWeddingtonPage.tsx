        ...
        <div className="container">
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl leading-relaxed mb-8">
              Professional ceramic coating for Weddington residents. GYEON &amp; IGL certified installers with 12+ years experience and 52 five-star reviews. Mobile service or convenient drop-off — ~10 min from our Waxhaw location.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-x-6 gap-y-3 text-sm text-muted-foreground">
              {["GYEON & IGL Certified", "Mobile & Drop-Off", "5.0 Stars (52 Reviews)", "~10 min from Weddington"].map((item) => (
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              {[
                { q: "Do you offer ceramic coating in Weddington?", a: "Yes! ProWorx Detailing serves Weddington with both mobile service (we come to your home or office) and drop-off at our Waxhaw location, ~10 min from our Waxhaw location. We're GYEON & IGL certified with 52 five-star Google reviews." },
