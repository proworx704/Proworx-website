...
export function CeramicCoatingMatthewsPage() {
  ...
  return (
    <div className="flex-1 flex flex-col">
      <PageSEO
        title="Ceramic Coating Matthews, NC"
        description="Ceramic coating in Matthews, NC by GYEON & IGL certified installers. 1-10 year protection from $499. Mobile or drop-off. 5-star rated."
        keywords="ceramic coating Matthews NC, auto detailing Matthews, paint correction Matthews Charlotte, car detailing Matthews NC, mobile detailing Matthews NC, GYEON ceramic coating Matthews"
        schema={{
          ...
          "@graph": [
            ...
            },
            {
              ...
              "areaServed": { "@type": "City", "name": "Matthews", "containedInPlace": { "@type": "State", "name": "North Carolina" } },
            ...
            },
            {
              "@type": "FAQPage",
              "mainEntity": [
                { "@type": "Question", "name": "Is there a ceramic coating installer near Matthews, NC?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. ProWorx Detailing is ~20 min from Matthews. We offer mobile service (we come to your Matthews home) and drop-off at our Waxhaw location. GYEON & IGL certified with 55+ five-star Google reviews." } },
                { "@type": "Question", "name": "How much does ceramic coating cost in Matthews?", "acceptedAnswer": { "@type": "Answer", "text": "Professional ceramic coating in Matthews starts at $499 for 1-year protection (GYEON Q² One EVO), $899 for 3-year (Q² Pure EVO), and $1,599 for 10-year (Q² Flash EVO). Price varies by vehicle size. All packages include prep wash, decontamination, and prep polish." } },
                { "@type": "Question", "name": "Does ProWorx offer mobile ceramic coating in Matthews?", "acceptedAnswer": { "@type": "Answer", "text": "Yes! We offer both mobile service and drop-off. For ceramic coating, drop-off is recommended for best results, but we accommodate mobile installations. Call (980) 272-1903 to discuss options." } }
              ]
            }
          ]
        }}
      ...
      <section className="relative py-20 md:py-28 overflow-hidden">
        <div className="absolute inset-0 -z-10">
          <CmsImg slot="matthews-hero" fallback="/images/tesla-bay.jpg" alt="Professional ceramic coating near Matthews, NC" className="w-full h-full object-cover" />
        ...
        <div className="container">
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl leading-relaxed mb-8">
              Professional ceramic coating for Matthews residents. GYEON &amp; IGL certified installers with 12+ years experience and 55+ five-star reviews. Mobile service or convenient drop-off — ~20 min from our Waxhaw location.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-x-6 gap-y-3 text-sm text-muted-foreground">
              {["GYEON & IGL Certified", "Mobile & Drop-Off", "5.0 Stars (55+ Reviews)", "~20 min from Matthews"].map((item) => (
          ...
          <div className="max-w-5xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                Matthews is a charming, family-oriented town on Charlotte's eastern edge — known for its walkable downtown, strong community pride, and residents who take pride in everything they own. From well-maintained SUVs in the Matthews Festival parking lot to luxury sedans along Saunders Road, this is a community that appreciates quality workmanship.
              </p>
              <p className="text-muted-foreground leading-relaxed mb-6">
                Matthews residents value reliability and attention to detail — whether it's choosing a local restaurant or selecting the right protection for their vehicle. That's why so many choose ProWorx's GYEON-certified ceramic coating.
              </p>
            ...
            <CmsImg slot="matthews-about" fallback="/images/porsche-van.jpg" alt="ProWorx mobile detailing serving Matthews, NC" className="rounded-2xl w-full aspect-[4/3] object-cover shadow-2xl" />
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-20 bg-card/50">
        <div className="container">
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
              We serve Matthews and the entire Charlotte metro area.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20">
        <div className="container">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-10 text-center">Common Questions — Matthews</h2>
            <div className="space-y-6">
              {[
                { q: "Do you offer ceramic coating in Matthews?", a: "Yes! ProWorx Detailing serves Matthews with both mobile service (we come to your home or office) and drop-off at our Waxhaw location, ~20 min from Matthews. We're GYEON & IGL certified with 55+ five-star Google reviews." },
                { q: "How much does ceramic coating cost in Matthews?", a: "Professional ceramic coating in Matthews starts at $499 for 1-year protection (GYEON Q² One EVO), $899 for 3-year protection (Q² Pure EVO), and $1,599 for 10-year protection (Q² Flash EVO). Pricing varies by vehicle size. We require a 30% deposit to book." },
