...
const PACKAGES = [
  { name: "Standard Detail", price: "From $206", features: ["Exterior hand wash & dry", "Tire & wheel cleaning", "Interior vacuum & wipe-down", "Glass cleaning inside & out", "Dashboard & console detail"], best: "Regular maintenance — keeps your car clean and fresh" },
        ...
        schema={{
          ...
          "@graph": [
            ...
            },
            {
              ...
              "offers": { "@type": "Offer", "priceRange": "$206-$735", "priceCurrency": "USD" }
            },
            {
              "@type": "FAQPage",
              "mainEntity": [
