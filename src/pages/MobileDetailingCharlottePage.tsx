        ...
        <div className="container">
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed mb-4">
              Professional detailing brought to your home, office, or anywhere in the Charlotte area. We're a fully self-contained, eco-friendly detail shop on wheels — 12+ years experience and 62+ five-star reviews.
            </p>
