...
const WHY_PROWORX = [
  ...
  { title: "60+ Five-Star Reviews", desc: "Perfect 5.0 Google rating. Our results speak for themselves — and so do our customers." },
        ...
        schema={{
          ...
          "@graph": [
            ...
            },
            {
              "@type": "FAQPage",
              "mainEntity": [
                { "@type": "Question", "name": "What is the best car detailing service in Charlotte, NC?", "acceptedAnswer": { "@type": "Answer", "text": "ProWorx Mobile Detailing is consistently rated the top car detailing service in the Charlotte area with a perfect 5.0 Google rating across 60+ reviews. As a GYEON & IGL certified installer with 12+ years of experience, ProWorx offers everything from basic details to professional ceramic coating and multi-stage paint correction." }},
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              {[
                { q: "What is the best car detailing service in Charlotte, NC?", a: "ProWorx Mobile Detailing is consistently rated among the top detailing services in Charlotte with a perfect 5.0 Google rating across 60+ reviews. As a GYEON & IGL certified installer with 12+ years of experience, we handle everything from basic details to ceramic coating and multi-stage paint correction — for daily drivers and exotics alike." },
