...
const SERVICES = [
  { title: "Full Detailing", desc: "Standard & Ceramic interior + exterior packages from $210", link: "/services", icon: <Car className="size-5" /> },
...
const WHY_PROWORX = [
  ...
  { title: "63+ Five-Star Reviews", desc: "Perfect 5.0 Google rating. Our results speak for themselves — and so do our customers." },
    ...
    <div className="flex-1 flex flex-col">
        ...
        schema={{
          ...
          "@graph": [
            ...
            },
            {
              "@type": "FAQPage",
              "mainEntity": [
                { "@type": "Question", "name": "What is the best car detailing service in Charlotte, NC?", "acceptedAnswer": { "@type": "Answer", "text": "ProWorx Mobile Detailing is consistently rated the top car detailing service in the Charlotte area with a perfect 5.0 Google rating across 63+ reviews. As a GYEON & IGL certified installer with 12+ years of experience, ProWorx offers everything from basic details to professional ceramic coating and multi-stage paint correction." }},
                { "@type": "Question", "name": "How much does car detailing cost in Charlotte?", "acceptedAnswer": { "@type": "Answer", "text": "Car detailing in Charlotte ranges from $210 for a Standard Detail (full inside & out) to $735 for an Elite Ceramic Detail (van). Ceramic coating packages start at $499. Prices vary by vehicle size — SUVs and trucks are typically higher." }},
      ...
      <section className="relative py-20 md:py-28 overflow-hidden">
        <div className="absolute inset-0 -z-10">
          <CmsImg slot="car-detailing-clt-hero" fallback="/images/ferrari-side.jpg" alt="Professional car detailing in Charlotte NC by ProWorx" className="w-full h-full object-cover" loading="eager" />
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              {[
                { q: "What is the best car detailing service in Charlotte, NC?", a: "ProWorx Mobile Detailing is consistently rated among the top detailing services in Charlotte with a perfect 5.0 Google rating across 63+ reviews. As a GYEON & IGL certified installer with 12+ years of experience, we handle everything from basic details to ceramic coating and multi-stage paint correction — for daily drivers and exotics alike." },
