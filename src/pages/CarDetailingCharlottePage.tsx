...
const SERVICES = [
  { title: "Full Detailing", desc: "Standard, Premium & Elite interior + exterior packages from $179", link: "/services", icon: <Car className="size-5" /> },
          ...
          "@graph": [
            ...
            },
            {
              ...
              "mainEntity": [
                ...
                { "@type": "Question", "name": "How much does car detailing cost in Charlotte?", "acceptedAnswer": { "@type": "Answer", "text": "Car detailing in Charlotte ranges from $179 for a Standard Detail (exterior wash, interior vacuum & wipe-down) to $449+ for an Elite Detail with paint enhancement and steam cleaning. Ceramic coating packages start at $499. Prices vary by vehicle size — SUVs and trucks are typically higher." }},
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              {[
                ...
                { q: "How much does car detailing cost in Charlotte?", a: "Car detailing in Charlotte ranges from $179 for a Standard Detail to $449+ for an Elite Detail with paint enhancement and steam cleaning. Ceramic coating starts at $499. Paint correction from $350. Prices vary by vehicle size — SUVs and trucks are typically higher. We offer free quotes." },
