...
const SERVICES = [
  { title: "Full Detailing", desc: "Standard, Premium & Elite interior + exterior packages from $258", link: "/services", icon: <Car className="size-5" /> },
