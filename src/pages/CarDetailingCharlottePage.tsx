...
const SERVICES = [
  { title: "Full Detailing", desc: "Standard & Ceramic interior + exterior packages from $206", link: "/services", icon: <Car className="size-5" /> },
