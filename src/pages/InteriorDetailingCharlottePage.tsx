  ...
  return (
    <div className="flex-1 flex flex-col">
      <PageSEO
        ...
        description="Professional interior detailing in Charlotte, NC. Deep cleaning, leather care, steam cleaning, stain & odor removal. Mobile service. 5.0\u2605 rated with 62+ reviews. Book today."
        ...
        <div className="container">
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed mb-4">
              Deep cleaning, leather care, steam sanitization, and stain removal for every surface inside your vehicle. Mobile service to your door or drop-off available. 12+ years experience, 62+ five-star Google reviews.
            </p>
        ...
        <div className="container">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                { icon: <Star className="size-6" />, title: "62+ Five-Star Reviews", desc: "Perfect 5.0 Google rating. Our interior work is consistently praised for attention to detail and thoroughness." },
