        ...
        <div className="container">
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl leading-relaxed mb-8">
              Professional ceramic coating for South Charlotte residents. GYEON &amp; IGL certified installers with 12+ years experience and 61+ five-star reviews. Mobile service or convenient drop-off — ~18 min from our Waxhaw location.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-x-6 gap-y-3 text-sm text-muted-foreground">
              {["GYEON & IGL Certified", "Mobile & Drop-Off", "5.0 Stars (61+ Reviews)", "~18 min from South Charlotte"].map((item) => (
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  { icon: <Star className="size-5" />, label: "5.0 Stars", sub: "61+ Google Reviews" },
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              {[
                { q: "Do you offer ceramic coating in South Charlotte?", a: "Yes! ProWorx Detailing serves South Charlotte with both mobile service (we come to your home or office) and drop-off at our Waxhaw location, ~18 min from South Charlotte. We're GYEON & IGL certified with 61+ five-star Google reviews." },
