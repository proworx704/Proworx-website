...
const NEARBY = [
  { name: "South Charlotte", distance: "~18 min" },
...
export function CeramicCoatingSouthCharlottePage() {
    ...
    <div className="flex-1 flex flex-col">
          ...
          "@graph": [
            {
              ...
              "itemListElement": [
                ...
                { "@type": "ListItem", "position": 3, "name": "South Charlotte, NC", "item": "https://www.proworxdetailing.com/ceramic-coating-south-charlotte-nc" }
              ]
            },
            {
              "@type": "LocalBusiness",
              "name": "ProWorx Detailing",
              "description": "GYEON & IGL certified ceramic coating and auto detailing serving South Charlotte, NC. Mobile service and drop-off available.",
              "url": "https://www.proworxdetailing.com/ceramic-coating-south-charlotte-nc",
      ...
      <section className="relative py-20 md:py-28 overflow-hidden">
        <div className="absolute inset-0 -z-10">
          <CmsImg slot="southcharlotte-hero" fallback="/images/tesla-bay.jpg" alt="Professional ceramic coating near South Charlotte, NC" className="w-full h-full object-cover" />
        ...
        <div className="container">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-gold/30 bg-gold/10 text-gold text-sm font-medium mb-6">
              ...
              Serving South Charlotte, NC & Surrounding Areas
            </div>
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-black tracking-tight leading-[1.05] mb-6">
              Ceramic Coating{" "}
              <span className="text-gradient-gold">South Charlotte, NC</span>
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl leading-relaxed mb-8">
              Professional ceramic coating for South Charlotte residents. GYEON &amp; IGL certified installers with 12+ years experience and 57+ five-star reviews. Mobile service or convenient drop-off — ~18 min from our Waxhaw location.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-x-6 gap-y-3 text-sm text-muted-foreground">
              {["GYEON & IGL Certified", "Mobile & Drop-Off", "5.0 Stars (57+ Reviews)", "~18 min from South Charlotte"].map((item) => (
      ...
      <section className="py-16 md:py-20">
        <div className="container">
          <div className="max-w-5xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-sm font-semibold text-gold uppercase tracking-widest mb-3">South Charlotte, NC</p>
              <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-6">
                Why South Charlotte Residents Choose ProWorx
              </h2>
              <p className="text-muted-foreground leading-relaxed mb-4">
                South Charlotte encompasses some of the most affluent neighborhoods in the metro area — from Providence Country Club to Rea Road and the Arboretum district. This stretch of Charlotte is home to executives, entrepreneurs, and families who drive everything from Audi Q7s to Porsche Cayennes. The vehicles in every driveway here tell the story of success.
              </p>
              <p className="text-muted-foreground leading-relaxed mb-6">
                South Charlotte professionals demand the same quality in vehicle care as they do in everything else. ProWorx's certified ceramic coating delivers that premium standard, protecting luxury vehicles from the inside out.
              </p>
              <div className="grid grid-cols-2 gap-4">
                {[
                  { icon: <Shield className="size-5" />, label: "Certified Installers", sub: "GYEON & IGL" },
                  { icon: <Truck className="size-5" />, label: "Mobile Service", sub: "We come to South Charlotte" },
                  { icon: <Star className="size-5" />, label: "5.0 Stars", sub: "57+ Google Reviews" },
            ...
            <CmsImg slot="southcharlotte-about" fallback="/images/porsche-van.jpg" alt="ProWorx mobile detailing serving South Charlotte, NC" className="rounded-2xl w-full aspect-[4/3] object-cover shadow-2xl" />
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-20">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-4">All Services Available in South Charlotte</h2>
          </div>
      ...
      <section className="py-16 md:py-20 bg-card/50">
        <div className="container">
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-4">Service Areas Near South Charlotte</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
              We serve South Charlotte and the entire Charlotte metro area.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20">
        <div className="container">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-10 text-center">Common Questions — South Charlotte</h2>
            <div className="space-y-6">
              {[
                { q: "Do you offer ceramic coating in South Charlotte?", a: "Yes! ProWorx Detailing serves South Charlotte with both mobile service (we come to your home or office) and drop-off at our Waxhaw location, ~18 min from South Charlotte. We're GYEON & IGL certified with 57+ five-star Google reviews." },
