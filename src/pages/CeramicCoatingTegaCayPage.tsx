        ...
        <div className="container">
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl leading-relaxed mb-8">
              Professional ceramic coating for Tega Cay residents. GYEON &amp; IGL certified installers with 12+ years experience and 56 five-star reviews. Mobile service or convenient drop-off — ~25 min from our Waxhaw location.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-x-6 gap-y-3 text-sm text-muted-foreground">
              {["GYEON & IGL Certified", "Mobile & Drop-Off", "5.0 Stars (56 Reviews)", "~25 min from Tega Cay"].map((item) => (
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              {[
                { q: "Do you offer ceramic coating in Tega Cay?", a: "Yes! ProWorx Detailing serves Tega Cay with both mobile service (we come to your home or office) and drop-off at our Waxhaw location, ~25 min from our Waxhaw location. We're GYEON & IGL certified with 56 five-star Google reviews." },
