  ...
  return (
    <div className="flex-1 flex flex-col">
      <PageSEO
        ...
        description="Professional auto detailing in Charlotte, NC. Interior & exterior detail, paint correction, ceramic coating. Mobile or drop-off. 5.0★ rated with 61+ reviews, 12+ years experience. Book today."
        ...
        <div className="container">
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed mb-4">
              Professional auto detailing for Charlotte and surrounding areas. Interior &amp; exterior detail, paint correction, and ceramic coating — mobile or drop-off. 12+ years experience and 61+ five-star Google reviews.
            </p>
        ...
        <div className="container">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                { icon: <Star className="size-6" />, title: "61+ Five-Star Reviews", desc: "Perfect 5.0 Google rating. Charlotte's highest-rated auto detailing service with 100% positive reviews." },
