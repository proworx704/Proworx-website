...
const SERVICES = [
  ...
  { icon: <Shield className="size-5" />, title: "Ceramic Coating", desc: "GYEON & IGL certified — 1 to 10-year paint protection from $499", link: "/ceramic-coating-charlotte-nc" },
  ...
  return (
    <div className="flex-1 flex flex-col">
      <PageSEO
        ...
        description="Professional auto detailing in Charlotte, NC. Interior & exterior detail, paint correction, ceramic coating. Mobile or drop-off. 5.0★ rated with 62+ reviews, 12+ years experience. Book today."
        ...
        <div className="container">
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed mb-4">
              Professional auto detailing for Charlotte and surrounding areas. Interior &amp; exterior detail, paint correction, and ceramic coating — mobile or drop-off. 12+ years experience and 62+ five-star Google reviews.
            </p>
            <div className="flex items-center gap-2 text-sm text-gold mb-8">
              ...
              <span className="text-muted-foreground">5.0 on Google (62+ reviews)</span>
            </div>
        ...
        <div className="container">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                { icon: <Star className="size-6" />, title: "62+ Five-Star Reviews", desc: "Perfect 5.0 Google rating. Charlotte's highest-rated auto detailing service with 100% positive reviews." },
