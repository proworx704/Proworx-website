...
const PACKAGES = [
  { name: "Standard Detail", price: "From $210", features: ["Exterior hand wash & dry", "Tire & wheel cleaning", "Interior vacuum & wipe-down", "Glass cleaning inside & out", "Dashboard & console detail"], best: "Regular maintenance — keeps your vehicle clean and fresh" },
...
const SERVICES = [
  { icon: <Car className="size-5" />, title: "Full Detailing", desc: "Complete interior & exterior detail packages from $210", link: "/services" },
          ...
          "@graph": [
            ...
            },
            {
              ...
              "hasOfferCatalog": {
                ...
                "itemListElement": [
                  { "@type": "OfferCatalog", "name": "Auto Detailing", "itemListElement": [{ "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Standard Auto Detail" }, "price": "210", "priceCurrency": "USD" }] },
