        ...
        <div className="container">
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed mb-4">
              Remove swirl marks, scratches, water spots, and oxidation with professional multi-stage machine polishing. Restore your vehicle's showroom finish — backed by 12+ years of experience and 63+ five-star reviews.
            </p>
