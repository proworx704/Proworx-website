  ...
  return (
    <div className="flex-1 flex flex-col">
      <PageSEO
        ...
        description="Professional exterior detailing in Charlotte, NC. Hand wash, clay bar, paint correction, ceramic coating, and paint protection. Mobile service. 5.0\u2605 rated with 61+ reviews. Book today."
        ...
        <div className="container">
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed mb-4">
              Hand wash, clay bar, paint correction, and ceramic coating from Charlotte's highest-rated detailing service. Mobile to your door or drop-off available. 12+ years experience and 61+ five-star Google reviews.
            </p>
        ...
        <div className="container">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                { icon: <Star className="size-6" />, title: "61+ Five-Star Reviews", desc: "Perfect 5.0 Google rating. Our exterior results speak for themselves in every review." },
