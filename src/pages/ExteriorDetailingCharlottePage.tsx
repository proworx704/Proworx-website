...
const PACKAGES = [
  ...
  { name: "Premium Exterior", price: "From $210", features: ["Everything in Standard", "Clay bar decontamination", "1-step polish", "Paint sealant application", "Plastic & trim dressing", "Exhaust tip polishing"], popular: true, best: "Deep clean & protect \u2014 removes contaminants and seals paint" },
            ...
            },
            {
              ...
              "hasOfferCatalog": {
                ...
                "itemListElement": [
                  ...
                  { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Premium Exterior Detail" }, "price": "210", "priceCurrency": "USD" },
        ...
        <div className="container">
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed mb-4">
              Hand wash, clay bar, paint correction, and ceramic coating from Charlotte's highest-rated detailing service. Mobile to your door or drop-off available. 12+ years experience and 63+ five-star Google reviews.
            </p>
        ...
        <div className="container">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                { icon: <Star className="size-6" />, title: "63+ Five-Star Reviews", desc: "Perfect 5.0 Google rating. Our exterior results speak for themselves in every review." },
