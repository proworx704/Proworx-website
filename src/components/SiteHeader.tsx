          ...
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <Button
                ...
                asChild
              >
                <a href="https://book.squareup.com/appointments/wa9b2qyqjdx71w/location/9VRKFJAZZM3HG/services" target="_blank" rel="noopener noreferrer" onClick={() => trackBookNowConversion("https://book.squareup.com/appointments/wa9b2qyqjdx71w/location/9VRKFJAZZM3HG/services")}>
