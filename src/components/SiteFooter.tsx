        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed mb-6">
              Charlotte's premier mobile auto detailing service. Gyeon &amp; IGL certified.
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {[
                ...
                { label: "Build Your Package", href: "https://book.squareup.com/appointments/wa9b2qyqjdx71w/location/9VRKFJAZZM3HG/services" },
              ].map((link) => (
                <li key={link.label}>
                  <Link
                    to={link.href}
            ...
            <ul className="space-y-2">
              <li className="flex items-start gap-2.5 text-sm">
                ...
                <div className="text-muted-foreground">
                  <div>Mon - Fri: {config.hoursWeekday}</div>
                  <div>Saturday: {config.hoursSaturday}</div>
